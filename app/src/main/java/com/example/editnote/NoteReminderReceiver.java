...
public class NoteReminderReceiver extends BroadcastReceiver {
    ...
    public static final String EXTRA_NOTE_ID = "com.example.editnote.extra.NOTE_ID";
    public static final String EXTRA_NOTE_TITLE = "com.example.editnote.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.example.editnote.extra.NOTE_TEXT";
    @Override
